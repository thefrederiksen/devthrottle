...
/// <summary>What kind of delivery the Gateway is driving. <see cref="TypedPrompt"/> is a typed prompt held in the typed
/// prompt store (Voice Delivery phase 5, contract section 7), driven by the same driver on the same three wake-ups.</summary>
public enum HeldDeliveryKind { Dictation, SendAnyway, TypedPrompt }
