...
namespace CcDirector.Gateway.Data.Migrations
{
    ...
    [Migration("20260921131049_IndexFactoryActivityReads")]
    partial class IndexFactoryActivityReads
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.DevReportEntity", b =>
                {
                    ...
                    b.ToTable("dev_reports", (string)null);
                });
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.DevReportReplyEntity", b =>
                {
                    ...
                    b.ToTable("dev_report_replies", (string)null);
                });
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.DevReportVersionEntity", b =>
                {
                    ...
                    b.ToTable("dev_report_versions", (string)null);
                });
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.FactoryActivityEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("FactoryAgent")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");

                    b.Property<string>("FactoryAgentVersion")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.FleetManagerEventEntity", b =>
                {
                    ...
                    b.ToTable("fleet_manager_events", (string)null);
                });
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.TriggerEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");

                    b.Property<string>("CheckCommand")
                        .IsRequired()
                        .HasMaxLength(2048)
                        .HasColumnType("TEXT");

                    b.Property<string>("ClaimedByDirectorId")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.TriggerRunEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("TenantId", "TriggerId", "RecordedUtc");
            ...
            modelBuilder.Entity("CcDirector.Gateway.Data.Entities.TurnVerdictTraceEntity", b =>
                {
                    ...
                    b.ToTable("turn_verdict_traces", (string)null);
                });
