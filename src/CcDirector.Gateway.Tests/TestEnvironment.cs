...
internal static class TestEnvironment
{
    ...
    internal static void Init()
    {
        ...
        // devthrottle_internal #2213: a hosted Gateway names the account on every AI call and refuses to call
        // for a real tenant without its service credential. A test host serving real tenants is configured
        // like the hosted one. AiCallTagTests proves the refusal with the variable cleared.
