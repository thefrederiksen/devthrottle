...
public sealed class RemoveAssistantSettingsPostgresTests
{
    ...
    private const string MigrationBefore = "20260917040647_AddFleetOutcomeAdvice";
    private const string MigrationUnderTest = "20260917060010_RemoveAssistantSettings";
