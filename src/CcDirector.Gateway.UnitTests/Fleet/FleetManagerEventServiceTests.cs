...
public sealed class FleetManagerEventServiceTests : IDisposable
{
    ...
    public FleetManagerEventServiceTests()
    {
        ...
        var verdictEnv = new GatewayTurnVerdictEnvironment(
            ...
            // Main's narration-plan parameter (pull request 3018): this class judges stops, it does not
            // narrate, so the plan is the allowing one and nothing here reads it.
