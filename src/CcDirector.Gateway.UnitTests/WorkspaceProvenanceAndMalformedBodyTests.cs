...
public sealed class WorkspaceProvenanceAndMalformedBodyTests : IDisposable
{
    ...
    public void An_ordinary_write_cannot_rewrite_where_a_captured_workspace_came_from()
    {
        ...
        // own is not evidence that anything was restored. That id is written by the restore, never by an
        // ordinary write (the Message Load mission, inspection 7, ruling 1).
        WorkspaceOwedSeatsAndOriginRulesTests.RecordRestored(
            store, "director-restart", "5ff9ab8b-07d3-4b23-953b-6c853760b56c", "9a1b0c2d-0000-4000-8000-000000000000");
