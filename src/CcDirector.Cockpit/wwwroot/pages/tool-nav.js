...
(function () {
  ...
  var ITEMS = [
    ...
    { href: "/feedback",    label: "Feedback",  icon: '<path d="M2.5 3.5h11v7h-6L4 13.5v-3h-1.5z"/><path d="M5 6h6M5 8h4"/>' },
    ...
    { href: "/exes",        label: "Builds",    icon: '<path d="M8 1.5 14 5v6l-6 3.5L2 11V5l6-3.5zM2 5l6 3.5L14 5M8 8.5v6"/>' },
    { href: "/transcripts", label: "Voice",     icon: '<rect x="6" y="1.5" width="4" height="8" rx="2"/><path d="M3.5 7.5a4.5 4.5 0 0 0 9 0M8 12v2.5"/>' },
