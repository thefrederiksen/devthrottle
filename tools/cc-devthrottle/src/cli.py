...
def message_send(
    ...
    """Send a message to one session, or to your team with the target 'all'.

    Add --everyone (with --reason and --grant) to reach the whole fleet.
    """
...
def message_ask(
    ...
    """Ask one session a question, wait, and print its answer."""
